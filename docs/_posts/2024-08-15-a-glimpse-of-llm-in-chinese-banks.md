...
最近配合同事准备一份向董事长汇报的材料，调研其他银行的大模型研发和应用情况。在网上看了工行、建行、交行、招行、兴业关于大模型的公开报道，可以说乏善可陈。其中，工行和兴业在大模型研发领域做了些工作，聊胜于无，其他银行几乎看不到有价值的探索。
...
其中，工行、平安和兴业的落地场景最为清晰。工行和平安分别是国有行和股份制行中的金融科技领导者，尤其平安，金融科技研发实力很强。兴业能快速落地这么多场景，有点出乎意料，可能也在加大科技投入吧。

六大国有行中，具备大模型自研能力的银行似乎只有工行。所谓“率先构建千亿级AI大模型技术体系”，从[另一篇报道](https://www.nbd.com.cn/articles/2023-03-30/2735332.html)来看，应该是和鹏城实验室、清华、中科院、华为一起研发了千亿参数大模型，基于昇腾AI，而且在多个场景落地：
...
然而，客户来电诉求和情绪识别完全不需要大模型，小模型即可做出又快又准的判断；进度监测不知为何物，不做评论；从审批书中提取核心要素，在无标注数据的情况下，使用大模型较为妥当。多方参与大模型研发，银行一般是甲方角色，是技术贡献度最低的一方。但是，工行敢吃螃蟹，这一点值得表扬。
...
这篇报道发表于7月底，比上面的表格晚了3个月。可见，ChatCIB可能不是兴业自研大模型。ALT-GPT是如何训练的呢？我猜测是基于某个开源大模型，用兴业积累的大量可疑交易报告和行为特征微调，例如，输入行为特征，输出可疑报告。难度不大，但是想法独特，好像从没有银行专门研发反洗钱大模型，值得表扬。
...
总体上看，各大银行都进入大模型军备竞赛，争先恐后，或采购，或自研。但是，出彩的场景并不多。这也无可厚非，毕竟银行是需要极度安全、极度可靠的服务，大模型目前为止还是黑盒，限制了它在严肃场景中的使用范围。个人认为，与其滥用，不如不用。很多场景可以使用小模型解决，就没有必要投产大模型。然而，银行技术力量相对薄弱，有时不知道什么场景该用什么模型，这时特别需要“懂行”的算法专家合理评估，最大限度发挥各种模型的特长，而不是死磕大模型。不管大模型小模型，能解决问题的就是好模型。
